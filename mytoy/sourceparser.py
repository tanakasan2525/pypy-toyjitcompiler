...
from mytoy import mytoydir
from mytoy import bytecode

grammar = py.path.local(mytoydir).join('grammar.txt').read("rt")
...
class ConstantInt(Node):
    ...
    def compile(self, ctx):
        ...
        from mytoy.interpreter import W_IntObject
...
class ConstantFloat(Node):
    ...
    def compile(self, ctx):
        ...
        from mytoy.interpreter import W_FloatObject
